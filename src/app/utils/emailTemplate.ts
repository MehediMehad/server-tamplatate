...
export const confirmEmailHTML = (
  ...
  return `
          <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>You can log in using the above credentials.</p>
...
export const sendEmailHTML = (title: string, message: string) => {
  return `
    <!DOCTYPE html>
    <html>
      <body style="margin:0; padding:0; background-color:#f9f9f9; font-family:Arial, sans-serif;">
        <table align="center" width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; box-shadow:0 0 10px rgba(0,0,0,0.05); margin-top:30px;">
          <tr>
            <td style="background-color:#FF6B00; color:#ffffff; padding:20px; text-align:center; font-size:24px; font-weight:bold;">
              ${title}
            </td>
          </tr>
          <tr>
